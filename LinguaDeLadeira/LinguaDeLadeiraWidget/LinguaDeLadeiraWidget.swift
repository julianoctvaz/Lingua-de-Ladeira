...
//
//  Created by Beatrix Lee on 11/02/21.
//
...
//                    .padding(.trailing, -iconPadding(width: geometry.size.width))
                ...
                VStack (alignment: .leading){
                    ...
                    Text("Depois de passar um ano \nna vontade, você finalmente pode ir pular carnaval com \na galera da Academy, hosteados no Bigode pelo ilustre Forminhos.")
                        .font(.caption2)
